...
this snippet gives illustraction of how estimator can be realized
"""
...
if __name__ == "__main__":
    "ipython -i test/abalone.py -- --train_data data/abalone_train.csv --test_data data/abalone_test.csv --predict_data data/abalone_predict.csv"
