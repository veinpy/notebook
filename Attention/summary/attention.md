...
+ [A PAINLESS ATTENTION MECHANISM FOR CONVOLUTIONAL NEURAL NETWORKS](../A PAINLESS ATTENTION MECHANISM FOR CONVOLUTIONAL NEURAL NETWORKS/A PAINLESS ATTENTION MECHANISM FOR CONVOLUTIONAL NEURAL NETWORKS.md)  
+ [Attentive Convolution](../Attentive Convolution/Attentive Convolution.md)
+ [QANET_ COMBINING LOCAL CONVOLUTION WITH GLOBAL SELF-ATTENTION FOR READING COMPREHENSION](../QANET_ COMBINING LOCAL CONVOLUTION WITH GLOBAL SELF-ATTENTION FOR READING COMPREHENSION/QANET- COMBINING LOCAL CONVOLUTION WITH GLOBAL SELF-ATTENTION FOR READING COMPREHENSION.md)
